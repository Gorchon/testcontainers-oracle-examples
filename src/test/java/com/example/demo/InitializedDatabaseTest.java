...
public class InitializedDatabaseTest {
    ...
    static OracleContainer oracleContainer = new OracleContainer("gvenzl/oracle-free:23.6-slim-faststart")
            ...
            .withInitScript("schemaaa.sql")
            .withCreateContainerCmdModifier(cmd -> cmd.withPlatform("linux/amd64")); // <- THIS IS THE FIX!
    ...
    void getUsuario() throws SQLException {
        try (Connection conn = ds.getConnection();
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM USUARIOS WHERE USUARIO_ID = 101")) {

            Assertions.assertTrue(rs.next(), "No se encontró el usuario con ID = 101");
            assertThat(rs.getString("NOMBRE")).isEqualTo("José María Soto Valenzuela");
        }
    }
}
